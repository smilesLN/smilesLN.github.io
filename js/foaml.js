...
function tonav() {
    ...
    document.getElementById("page-name").innerText = document.title.split(" | LN")[0];
}
...
function createtime1() {
    var grt = new Date("01/04/2021 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function share_() {
    ...
    try {
        ...
        var subTitle = title.endsWith("| LN🐋") ? title.substring(0, title.length - 14) : title;
        navigator.clipboard.writeText('LN🐋的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！☀☀☀');
        new Vue({
            data: function () {
                this.$notify({
                    title: "成功复制分享信息👍",
...
l = ["非常抱歉，因为不可控原因，博客将于明天停止运营！", "好消息，日本没了！", "美国垮了，原因竟然是川普！", "微软垮了！", "你的电脑已经过载，建议立即关机！", "你知道吗？站长很喜欢你哦！", "一分钟有61秒哦", "我喜欢你"]
...
if (m == 4 && dd == 24) {//LN生日
    if (sessionStorage.getItem("isPopupWindow") != "1") {
        Swal.fire("祝LN生日快乐" + (y - 1996).toString() + "岁生日快乐！");
        sessionStorage.setItem("isPopupWindow", "1");
    }
}
if (m == 5 && dd == 1) {//劳动节
...
function createtime() {
  ...
  var start = new Date("04/01/2024 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  var grt = new Date("04/01/2024 00:00:00");	// 网站诞生时间
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
    ? `<img class='boardsign' src='https://pic.imgdb.cn/item/6620b20b0ea9cb1403f0f73d.png' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
    : `<img class='boardsign' src='https://pic.imgdb.cn/item/6620b20b0ea9cb1403f0faf5.png' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/2.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/3.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/4.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/5.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/6.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/7.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/8.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/8.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/9.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/9.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/10.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/10.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/11.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/dongman/11.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/11.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/11.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/17.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/17.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/5.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/10.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/10.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/2.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/3.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/4.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/5.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/6.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/7.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/8.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/8.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/9.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/fengjing/9.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/4.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/fengmian/4.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/2.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/3.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/4.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/5.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/bgset/mengchong/5.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看渐变色背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" class="box" style="background: linear-gradient(to top, #355c7d, #6c5b7b, #c06c84)" onclick="changeBg('linear-gradient(to top, #355c7d, #6c5b7b, #c06c84)')"></a><a href="javascript:;" rel="noopener external nofollow" class="box" style="background: linear-gradient(to top, #ccccff, #ff99cc, #99ccff)" onclick="changeBg('linear-gradient(to top, #ccccff, #ff99cc, #99ccff)')"></a><a href="javascript:;" rel="noopener external nofollow" class="box" style="background: linear-gradient(to top, #ccff99, #ffccff, #ffcc99)" onclick="changeBg('linear-gradient(to top, #ccff99, #ffccff, #ffcc99)')"></a><a href="javascript:;" rel="noopener external nofollow" class="box" style="background: linear-gradient(to top, #ffccff, #ccffcc, #ffcccc)" onclick="changeBg('linear-gradient(to top, #ffccff, #ccffcc, #ffcccc)')"></a><a href="javascript:;" rel="noopener external nofollow" class="box" style="background: linear-gradient(to top, #66ccff, #99ffcc, #ffcccc)" onclick="changeBg('linear-gradient(to top, #66ccff, #99ffcc, #ffcccc)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看纯色背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" class="box" style="background: #f7eff5" onclick="changeBg('#f7eff5')"></a>  <a href="javascript:;" rel="noopener external nofollow" class="box" style="background: #33ccff" onclick="changeBg('#f7eff5')"></a><a href="javascript:;" rel="noopener external nofollow" class="box" style="background: #ff99cc" onclick="changeBg('#f7eff5')"></a><a href="javascript:;" rel="noopener external nofollow" class="box" style="background: #ccff99" onclick="changeBg('#f7eff5')"></a><input type="color" id="colors" href="javascript:;" rel="noopener external nofollow" class="box" autocomplete="on" value="${defineColor}" oninput="changeBgColor()"></input></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <p><div class="bgbox"><br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/2.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/2.webp)')">&lt;/a&gt;<br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/3.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/3.webp)')"></a><br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/4.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/4.webp)')">&lt;/a&gt;<br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/5.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/5.webp)')"></a><br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/6.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/6.webp)')">&lt;/a&gt;<br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/7.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/7.webp)')"></a><br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/8.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/8.webp)')">&lt;/a&gt;<br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/9.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/9.webp)')"></a><br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/11.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/11.webp)')">&lt;/a&gt;<br><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/BG.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/smilesLN/img@main/phoneBG/BG.webp)')"></a></p>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p><center><input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://github.com/smilesLN/img/blob/main/fengmian/20.webp"></center></p><p><center><button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button></center></p>
              </div>
            </details>
